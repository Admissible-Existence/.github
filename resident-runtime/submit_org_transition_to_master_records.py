...
def main():
 ...
 if receipt.get("organization")!="Admissible-Existence":raise SystemExit("organization receipt owner mismatch")
 ...
 packet=K.build_packet(origin_org="Admissible-Existence",origin_service="admissible-existence.org-control",destination_org="master-records",destination_service="master-records.ecosystem-transition-ledger",payload=payload,transition_reference="ecosystem.transition.custody.v1",authority_effect="NONE")
