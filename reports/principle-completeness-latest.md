...
Generated: `2026-09-21T13:23:19.946242+00:00`
...
|---|---|---:|---:|---:|---|
| `Admissible-Existence/.github` | coordination | BLOCKED | 100.00% | 490 | `UNRESOLVED_PLACEHOLDERS` |
...
| `Admissible-Existence/STCM` | source | BLOCKED | 100.00% | 241 | `UNRESOLVED_PLACEHOLDERS` |

## Organization result

- Repositories audited: **5**
- Complete candidates: **0**
- Proven complete: **0** (independent review is not performed by this worker)
- Mean diagnostic coverage: **88.33%**
