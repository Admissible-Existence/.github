...
def main():
    ...
    expected=['Admissible-Existence/Existence','Admissible-Existence/GTG','Admissible-Existence/ET','Admissible-Existence/learning-transition-governance','Admissible-Existence/BC','Admissible-Existence/CHF']
    if data.get('completed_source_migrations')!=6: f.append('completed_source_migration_count_mismatch')
