...
def main():
    ...
    require(data.get('refresh_goal_id') == 'AEX-TRIFORM-MIGRATION-REFRESH-014', 'refresh_goal_id_mismatch', f)
    ...
    require(data.get('completed_source_migrations') == 14, 'completed_source_migration_count_mismatch', f)
